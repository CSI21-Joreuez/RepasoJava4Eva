 ...
 * Generated at: 2022-03-29 12:30:04 UTC
...
String [][] tablares = basededatos.resConsultaSelectA3(query);
      ...
      out.write("\r\n");
      out.write("<FORM name=\"introgrupo\" ACTION=\"select.jsp\" method=\"GET\"> \r\n");
      out.write("<SELECT name=\"valorgrp\" onchange=\"submit();\">\r\n");
      out.write("<option value=\"\">Elija un Curso...</option>\r\n");
 for (int i=0; i<tablares.length;i++) {
	
      out.write("<option value=\"");
      out.print(tablares[i][0]);
      out.write('"');
      out.write('>');
      out.print(tablares[i][0]);
      out.write('\r');
...
String [][] tablares2 = basededatos.resConsultaSelectA3(query2);
 ...
 if (tablares2!=null) {
      ...
      out.write("<h2>Alumnos del curso ");
      out.print(grprecibido);
      out.write("</h2>");
